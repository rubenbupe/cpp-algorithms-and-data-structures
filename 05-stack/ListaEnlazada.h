...
#ifndef ACTIVIDAD_4_5_LISTAENLAZADA_H
#define ACTIVIDAD_4_5_LISTAENLAZADA_H
...
public:
    ...
    // Concatena una lista al final de otro
    void concatenar(ListaEnlazada &lista2);
...
#endif //ACTIVIDAD_4_5_LISTAENLAZADA_H
