...
class ListaEnlazada
{
    ...
    // Parámetros:
    // - listaCompleta: lista original en donde están los elementos que vamos a repartirPorMergeSort
    ...
    // - listaCompleta->n >= 2 (si es menor, no hay nada que repartirPorMergeSort)
    ...
    int getPivote(ListaEnlazada *lista);
    ...
    // Parámetros:
    // - pivote: numero que usaremos para repartirPorMergeSort los elementos
    // - listaCompleta: lista original en donde están los elementos que vamos a repartirPorMergeSort
    ...
    // Complejidad temporal: O(n), siendo n el tamaño de listaCompleta
    // Complejidad espacial: O(1), pues quitamos los nodos de listaCompleta a medida que los ponemos en las sublistas
    void repartirPorQuickSort(int pivote, ListaEnlazada *listaCompleta, ListaEnlazada *sublista1, ListaEnlazada *sublista2);
