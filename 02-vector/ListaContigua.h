...
#ifndef ACTIVIDAD4_1_LISTACONTIGUA_H
#define ACTIVIDAD4_1_LISTACONTIGUA_H
...
public:
    ...
    //Inserta un elemento en la posicion i de la lisra
    void insertar(int nuevoValor, int i);

    //Elimina el elemento en la posicion i de la lista
    void eliminar(int i);

    //Concatena una ListaContigua al objeto
    void concatenar(const ListaContigua *otraLista);

    //Busca un numero en el array y devuelve su posicion
    int buscar(int num);
...
#endif //ACTIVIDAD4_1_LISTACONTIGUA_H
